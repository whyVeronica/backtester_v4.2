  ...
  if (store$iter > params$lookback) {
    ...
    for (i in 1:length(params$series)) {
      if (i==8){
        ...
        if (10000 < MAPnL[params$series[i]]  & MAPnL[params$series[i]] <= 100000) {
          posMAPnL[params$series[i]] <- 6
        }
        
        if (1000 < MAPnL[params$series[i]] & MAPnL[params$series[i]] <= 10000) {
          posMAPnL[params$series[i]] <- 4
        }
        
        if (100 < MAPnL[params$series[i]] & MAPnL[params$series[i]] <= 1000) {
          posMAPnL[params$series[i]] <- 2
        }
        ...
        posSizes[params$series[i]] <- posMAPnL[params$series[i]] * posOpdiff
