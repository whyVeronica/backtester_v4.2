...
getOrders <- function(store, newRowList, currentPos, params) {
  ...
  if (store$iter > max(params$lookback,params$lookback_macd,lookbackm,maxLookback1,maxLookback2)) {
    ...
    for (i in 1:length(params$series)) {
      if(i!=4&i!=8&i!=3&i!=6)  {
        ...
        cumPnL1 <<- CPnL1[startIndexWRL1:store$iter,params$series[i]]
        ...
        PD1 <- ifelse(MAPnL1[params$series[i]] > 0, 
                      MAPnL1[params$series[i]]/maxDrawdown1[store$iter,params$series[i]], 
                      MAPnL1[params$series[i]])
        #cat("PD1:",PD1,"\n")
        ######################################################################################################
        ...
        cumPnL2 <<- CPnL2[startIndexWRL2:store$iter,params$series[i]]
        ...
        PD2 <- ifelse(MAPnL2[params$series[i]] > 0, 
                      MAPnL2[params$series[i]]/maxDrawdown2[store$iter,params$series[i]], 
                      MAPnL2[params$series[i]])
    ...
    for (i in 1:length(params$series)) {
      if(i==3|i==6)  {
        ...
        cumPnL3 <<- CPnL3[startIndexWRL1:store$iter,params$series[i]]
        #cat("cumPnL1:",CPnL1[1:store$iter,params$series[i]],"\n")
        #cat("MAX cumPnL1:",max(cumPnL1),"\n")
        maxDrawdown3[store$iter,params$series[i]] <<- max(max(cumPnL3)-cumPnL3,maxDrawdown3[store$iter-1,params$series[i]])
        #cat("maxDrawdown1",maxDrawdown1[store$iter,],"\n")
        PD3 <- ifelse(MAPnL3[params$series[i]] > 0, 
                      MAPnL3[params$series[i]]/maxDrawdown3[store$iter,params$series[i]], 
                      MAPnL3[params$series[i]])
        #cat("PD1:",PD1,"\n")
        ######################################################################################################
        ...
        cumPnL4 <<- CPnL4[startIndexWRL2:store$iter,params$series[i]]
        #cat("cumPnL2:",CPnL2[1:store$iter,params$series[i]],"\n")
        #cat("MAX cumPnL2:",max(cumPnL2),"\n")
        maxDrawdown4[store$iter,params$series[i]] <<- max(max(cumPnL4)-cumPnL4,maxDrawdown4[store$iter-1,params$series[i]])
        #cat("maxDrawdown2",maxDrawdown2[store$iter,],"\n")
        PD4 <- ifelse(MAPnL4[params$series[i]] > 0, 
                      MAPnL4[params$series[i]]/maxDrawdown4[store$iter,params$series[i]], 
                      MAPnL4[params$series[i]])
        ...
        cumPnL5 <<- CPnL5[startIndex:store$iter,params$series[i]]
        #cat("cumPnL2:",CPnL2[1:store$iter,params$series[i]],"\n")
        #cat("MAX cumPnL2:",max(cumPnL2),"\n")
        maxDrawdown5[store$iter,params$series[i]] <<- max(max(cumPnL5)-cumPnL5,maxDrawdown5[store$iter-1,params$series[i]])
        #cat("maxDrawdown2",maxDrawdown2[store$iter,],"\n")
        PD5 <- ifelse(MAPnL5[params$series[i]] > 0, 
                      MAPnL5[params$series[i]]/maxDrawdown5[store$iter,params$series[i]], 
                      MAPnL5[params$series[i]])
