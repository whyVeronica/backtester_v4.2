...
cashFlow <- matrix(0,nrow=maxRows,ncol=10)
cashFlow1 <- matrix(0,nrow=maxRows,ncol=10)
cashFlow2 <- matrix(0,nrow=maxRows,ncol=10)
...
##########################################################################################################
  ...
  if (store$iter > max(maxLookback1,maxLookback2)) {
    ...
    for (i in 1:length(params$series)) {
      ...
      #print(currentCashFlow11[store$iter,params$series[i]])
